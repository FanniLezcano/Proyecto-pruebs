...
class PropiedadesDetalleVenta extends StatefulWidget {
  @override
  State<PropiedadesDetalleVenta> createState() =>
      _PropiedadesDetalleVentaState();
}

class _PropiedadesDetalleVentaState extends State<PropiedadesDetalleVenta> {
            ...
            SafeArea(
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    "Propiedades en venta de RE/MAX",
                  ...
                  SizedBox(height: 10),
                  Expanded(
                    child: FutureBuilder<List<Propiedades>>(
                        ...
                        if (snapshot.connectionState ==
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              Propiedades propiedad = snapshot.data![index];
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/activo-fijo.png"),
                  fit: BoxFit.cover,
                ),
